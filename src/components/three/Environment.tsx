  ...
  return (
    <>
      ...
      <group ref={particlesRef}>
        {/* Hero area particles - Valorant red/cyan */}
        <Float speed={2} rotationIntensity={0.5} floatIntensity={1}>
          <mesh position={[6, 2, -8]}>
            <sphereGeometry args={[0.15, 16, 16]} />
            <meshStandardMaterial color="#ff4655" emissive="#ff4655" emissiveIntensity={2} />
          </mesh>
        </Float>
        ...
        <Float speed={1.5} rotationIntensity={0.4} floatIntensity={1.2}>
          <mesh position={[-8, -12, -5]}>
            ...
            <meshStandardMaterial color="#1fb6ff" emissive="#1fb6ff" emissiveIntensity={2} />
          </mesh>
        </Float>
        ...
        <Float speed={2.2} rotationIntensity={0.5} floatIntensity={1.1}>
          <mesh position={[5, -42, -5]}>
            ...
            <meshStandardMaterial color="#1fb6ff" emissive="#1fb6ff" emissiveIntensity={1.5} />
          </mesh>
        </Float>
